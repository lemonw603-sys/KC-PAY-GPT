...
| 项目 | 事实 |
|---|---|
| release | `/opt/pojia/releases/20260907-cards-91bd4f9`（09-07 15:39 UTC，后台卡片页合一）；回滚点 `20260907-orders2-0238601`（再前 `20260907-orders-9ccd2a7`） |
