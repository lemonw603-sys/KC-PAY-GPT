...
| 项目 | 事实 |
|---|---|
| release | `/opt/pojia/releases/20260907-fivepages-6f1217f`（09-07 15:47 UTC，后台导航收成五页 + 诊断页）；回滚点 `20260907-cards-91bd4f9`（再前 `20260907-orders2-0238601`） |
