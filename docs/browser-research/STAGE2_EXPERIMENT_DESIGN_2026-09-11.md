...
## 2026-09-11 批复后更新
仅 Plus，Pro 5X/20X 与 UPGRADE_DIALOG_STOP 不属于实验对象；不买住宅出口、不做 IP 隔离或搬机。E0 实现和 E1 当前盘点限制、账号交付方式、单次点击限制及预检评估统一见 E0_E1_EVALUATION_2026-09-11.md。旧稿中 IP 固定只是观察一致性，不申请改变出口。E2 卡由大脑指定为 9839，仍等待 E1 结果与独立放行。
