...
> Fixture 生产刻意串行：首次并发 fixture 写入暴露了真实 `ER_LOCK_DEADLOCK`，已单列在 `docs/2026-08-22_browser-enqueue-producer-deadlock-adversarial-finding.md`，不与 claim/lease 主指标混淆。
