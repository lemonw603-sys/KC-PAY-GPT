...
## 2026-09-16｜统一成功时点候选（14:17 UTC）

按用户同意改回，隔离codex/unified-success撤回提前写SUCCESS和回调，保留其他提速/防重付/重试。数据库9/9、Browser294pass9skip、v1 675pass66skip。原测试文件重命名并改为只在取消核对完成才成功的断言。未部署/重启，线上仍旧早交付。证据docs/incidents/unified-success/。
