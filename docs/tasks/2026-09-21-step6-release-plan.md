...
> **D-328最新**：用户已批准容量最小修复、真实落库/恢复验收后继续发布。本地10项真实MySQL与默认980/0/69通过。新固定候选`8395fe3b19a3850c4566da64f05f148c17d9d57b`，新release名`20260921-step6-8395fe3`，迁移范围**055～058**；058只扩大setting_value容量，保留仅存544字符摘要的逻辑。先在维护前用旧备份跑候选恢复检查；迁移后Bark仍停时运行一次原日对账任务，独立读回摘要/心跳/告警，再备份恢复并继续switch。以下66bfe98为上一轮历史方案，不复用其目录。
