...
- 固定代码候选：`2d41192ac05a819aa0600c24b610a81e862c60b5`。
- 拟release名：`20260921-step6-2d41192`；prepare前检查同名目录不得已有不一致内容。
- 决策D-313～D-321；原型A与已有三份1440契约；联合核查、修复、迁移/恢复演练证据见docs/reviews下2026-09-21相关报告。
- 默认测试958 pass/0 fail/69 skipped；28迁移场景、6类订单恢复场景通过。不是所有生产资金动作/全项目MySQL套件全绿。
...
批准方式：用户明确同意按本方案现在执行第⑥步统一发布（含推送、备份、维护、临时授权/撤权、迁移与切换）。实际动手前重查停止条件，发现与计划不符就停下报告。
