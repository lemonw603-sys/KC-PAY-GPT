...
### 2026-08-31 客户/后台体验收敛（未部署）

在不改变 Provider、资金状态、自动补给和 Browser 执行器的前提下，补充 Session 粘贴整理、订单查询防重提和 CDK 生成会话复用。详见 `docs/2026-08-31_customer-admin-ux-session-cdk.md`；部署前需完成依赖安装后的完整 v1 套件与浏览器验收。
