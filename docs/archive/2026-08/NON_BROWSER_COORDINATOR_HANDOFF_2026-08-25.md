...
> 这是非 Browser **统筹/集成验收 worktree** 的接班入口。业务实现细节继续以 `docs/archive/2026-08/NON_BROWSER_HANDOFF_2026-08-25.md`、`docs/CURRENT_STATE.md`、`docs/DECISIONS.md` 为准；多窗口规则见 `docs/archive/2026-08/WORKSTREAM_COORDINATION_2026-08-25.md`。
...
- `docs/archive/2026-08/2026-08-25_non-browser-release-reconciliation.md` 的 release 证据；
