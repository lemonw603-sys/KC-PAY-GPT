...
- `docs/archive/2026-08/2026-08-24_browser-stage1-24h-soak-completion-report.md`
...
审查结论与修正见 `docs/archive/2026-08/2026-08-24_browser-dispatch-ambiguous-claim-review.md`。`claim()` 不再重试 ambiguous timeout/connection loss；`enqueue()`/`complete()`/heartbeat 的安全重试边界保留。对应提交：`7ead4d6`、`d394b53`。
...
- `docs/archive/2026-08/2026-08-22_nonph-observation-adversarial-review.md`
- `docs/archive/2026-08/2026-08-22_session-cookie-family-ab-evidence.md`
- `docs/archive/2026-08/BRFE_HANDOFF_2026-08-22.md`
- `docs/archive/2026-08/BROWSER_AUTOMATION_HANDOFF_2026-08-23.md`
- `artifacts/browser-soak/*`

本轮已核验的 24h 日志和独立查询见 `docs/archive/2026-08/2026-08-24_browser-stage1-24h-soak-completion-report.md`。旧元数据曾保持 `RUNNING`，不能单独作为完成证据；后续 runner 已修复完成回写。
...
- `docs/archive/2026-08/2026-08-23_browser-stage1-24h-soak-run.md`

下一动作：先完成 B/C/D 类文件的归属确认，再用分块 staging 方式提交，避免把非 Browser 改动混入 Browser commit。

## F. 非 Browser 或生成产物

当前工作区还包含 `CLAUDE.md`、`docs/archive/2026-08/AI_AGENT_ROLE_AND_READING_GUIDE_2026-08-21.md`、`docs/08-handoff/`、`docs/competitor-research/`、`output/`、`dogfood-output/`、`tools/` 和其他 `artifacts/` 内容。这些不属于本 Browser 整理范围，保持原状。
