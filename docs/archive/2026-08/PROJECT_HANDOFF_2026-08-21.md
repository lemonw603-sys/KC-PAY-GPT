...
- 独立对抗式审查已完成；报告见 `docs/archive/2026-08/ADVERSARIAL_AUDIT_2026-08-21.md`。
- 审查发现的 3 个 P1（告警重开不推送、写开关绕过、未来迁移误报）均已修复。
- 阶段性完结后的二次审查又补强了旧告警表迁移、辅助脚本写开关规范化、活动开卡任务体检和 Bark 重试 SQL；详见 `docs/archive/2026-08/ADVERSARIAL_AUDIT_2026-08-21.md`。
...
- 详细记录见 `docs/archive/2026-08/PROJECT_RENAME_2026-08-21.md`。
...
- `docs/archive/undated/IMPLEMENTATION_ACCEPTANCE.md`
- `docs/ROADMAP.md`
- `docs/archive/2026-08/ADVERSARIAL_AUDIT_2026-08-21.md`
- `docs/archive/undated/SMALL_BATCH_RUNBOOK.md`
- `docs/archive/2026-08/PROJECT_RENAME_2026-08-21.md`
- `progress.md`
...
8. 后续 AI 接手前必须先读本文、`docs/ROADMAP.md`、`docs/archive/undated/SMALL_BATCH_RUNBOOK.md` 和最新 `progress.md`。
...
- 详细事实、证据边界、横向平台和后续计划统一见 `docs/archive/2026-08/SINGLE_SOURCE_OF_TRUTH_2026-08-21.md`。

## 2026-08-22 运营后台审计与发布候选包交接补充

- 后台全量审计主文档：`docs/archive/2026-08/ADMIN_FULL_AUDIT_2026-08-22.md`。
- 修复后对抗式复核：`docs/archive/2026-08/ADMIN_REPAIR_ADVERSARIAL_REVIEW_2026-08-22.md`。
