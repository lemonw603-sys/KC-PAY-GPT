...
接班模型先读 `docs/archive/2026-08/BROWSER_CURRENT_STATUS_2026-08-22.md`，再读本报告和 `docs/contracts/2026-08-22_browser-multi-lane-experiment-contract.md`。不要把本节点的本地仿真误写成菲律宾真实测试或真实付款事实。
