...
## D-184（2026-09-12 12:40 UTC）发布前审查：九阶段的 SQL 写错列名，测试全绿但功能必然失效
...
## D-185（2026-09-12 14:20 UTC）带着发现问题的眼光回看过去：三处需要重新审视，其中一处是我当天刚下的错误结论
...
## D-186（2026-09-12 14:45 UTC）全量 SQL 探针：589 条对生产 schema 零失败；以及我的第四条惯犯
