...
| 可分配卡（资格 SQL，Plus 门槛 16） | **1 张：3118（$60.00，2026-09-11 10:52 UTC 新开，BIN 53211304）**。非终态订单 0。9839/7428/2911 已从卡台消失 → `source_present=0`、`MISSING_FROM_SNAPSHOT`、HELD_FOR_REVIEW（其中 9839 账面仍记 $50，需与 Lemon 核对是否本人销卡） | 2026-09-11 10:58 UTC | 资格 SQL 直接查 = 9839 |
