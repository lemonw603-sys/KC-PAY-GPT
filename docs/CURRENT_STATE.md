...
| 最新数据库备份 | /var/backups/pojia/pojia-20260916T141936Z.sql.gz.enc，完整性OK。 | 2026-09-16 15:36 UTC | 独立SSH/进程/DB查询与发布清单；docs/incidents/unified-success/ |
| pojia-web | active；PID2359155，cwd /opt/pojia/releases/20260916-unified-4334dc2/v1。 | 2026-09-16 15:36 UTC | 独立SSH/进程/DB查询与发布清单；docs/incidents/unified-success/ |
...
| pojia-worker（v1 任务 Worker） | active；PID2359160，cwd /opt/pojia/releases/20260916-unified-4334dc2/v1。 | 2026-09-16 15:36 UTC | 独立SSH/进程/DB查询与发布清单；docs/incidents/unified-success/ |
...
| accept_new_orders | true；本次维护短暂停接单后已通过正式服务恢复，付款开关未变。 | 2026-09-16 15:36 UTC | 独立SSH/进程/DB查询与发布清单；docs/incidents/unified-success/ |
...
| 活动资金与运行 | active_runs 0；非终态订单0；切换前SUCCESS待收尾run0。本次没有创建充值或付款。 | 2026-09-16 15:36 UTC | 独立SSH/进程/DB查询与发布清单；docs/incidents/unified-success/ |
...
| 本机 | 常驻Browser PID47905，15:35:18 UTC启动，PAY/pool:lane-1；心跳15:36:07.804Z。源码4334dc2，与服务端一致。 | 2026-09-16 15:36 UTC | 独立SSH/进程/DB查询与发布清单；docs/incidents/unified-success/ |
