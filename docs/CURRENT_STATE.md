...
| 最近真实单 | `PJV1-fQfm9fp_JZ2J10gGPzcL`（09:35 提交，账号 mengx612@gmail.com，Pilot，卡 9839）：预检一次过；正式流程填完卡与账单地址后因该版结账页无邮箱字段而**付款前安全中止**（CHECKOUT_DRIFT），**未点付款、未扣款**，卡与 CDK 均已退回。根因已修（D-157）。前一单 `PJV1-9TN0gGX`：付款点击一次后被 hCaptcha 拦，未扣款，已收口 | 2026-09-11 10:02 UTC | 生产主机 dry-run + 真跑输出；隧道新连接独立 SELECT（orders/tasks/cdks/cards/card_assignment_history） |
