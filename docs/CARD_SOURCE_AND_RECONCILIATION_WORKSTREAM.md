...
| D2 方案冻结 | 候选待终审 | `CARD_SOURCE_AND_RECONCILIATION_FROZEN_SPEC.md` D2-RC1 等待用户最终确认 |
...
用户终审 `docs/CARD_SOURCE_AND_RECONCILIATION_FROZEN_SPEC.md` D2-RC1；确认后将 D2 标记为已冻结，随后才允许进入 D3 实现映射和编码。
