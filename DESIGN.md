...
- **正文墨** (`hsl(176,18%,11%)`) / **次要墨** (`hsl(170,10%,38%)`) / **三级墨** (`hsl(168,9%,41%)`)：三层文字。三级墨 2026-09-24 从 50% 调到 41%（D-359），在白 / 卡片内嵌 / 控件底上分别 5.1 / 4.8 / 4.6:1，全部过 4.5。
- **金** (`hsl(38,46%,42%)`)：只在品牌标记的「✦」上。

### Semantic
- **警示** `hsl(32,72%,36%)`（2026-09-24 从 40% 调深，浅底上 4.6:1）/ 浅底 `hsl(38,78%,94%)`：需要人处理的状态（等 Session、付款待核实、续费待确认）。
