...
function normalizeRow(values, index) {
  ...
  if (![loaded, spent, balance].every(Number.isFinite) || loaded < 0 || spent < 0 || balance < 0) errors.push('INVALID_BALANCE');
